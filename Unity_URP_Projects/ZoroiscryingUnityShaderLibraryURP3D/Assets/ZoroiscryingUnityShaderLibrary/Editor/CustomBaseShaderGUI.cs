...
{
    /// <summary>
    /// This class is the copied class of the BaseShaderGUI
    ...
    public class CustomBaseShaderGUI : ShaderGUI
    {
        ...
        /// <summary>
        /// PBR Material Smoothness Option
        /// </summary>
        ...
        /// <summary>
        /// Styles to draw different properties
        /// </summary>
        protected class Styles
        {
            ...
            public static readonly GUIContent SurfaceOptions =
                EditorGUIUtility.TrTextContent("Surface Options", "Controls how the Engine Renders the material on screen.");
        ...
        /// <summary>
        /// Find material properties for future drawing
        /// </summary>
        ...
        /// <summary>
        /// OnGUI Core Drawing function,
        /// </summary>
        /// <param name="materialEditorIn"></param>
        ...
        /// <summary>
        /// Initialize the classes and properties, mainly the ScopeList
        /// </summary>
        ...
        /// <summary>
        /// Draw shader properties using the Material Scope List
        /// </summary>
        /// <param name="material"></param>
        ...
        /// <summary>
        /// Draw Float value as a toggle, and if the toggle is on, the float value will be set to 1
        /// </summary>
        ...
        /// <summary>
        /// Draw Surface Options of the material
        /// - Surface Type - Opaque / Transparent
        ///     - If Surface Type == Transparent - Blending mode - Alpha / Premultiply / Additive / Multiply
        /// - Culling Type - Front(2) / Back(1) / Both(0)
        /// - ZWrite Mode - Auto / ForceEnabled / ForceDisabled
        ///     - If ZTestProp != null - ZTest Mode - Please Refer to ZTest Mode Enum
        /// - Alpha Clip - On / Off
        ///     - If Alpha Clip == 1 - Alpha Clip
        /// - Cast Shadow - On / Off
        /// - Receive Shadow - On / Off
        /// </summary>
        /// <param name="material"></param>
        public virtual void DrawSurfaceOptions(Material material)
        {
            DoPopup(Styles.surfaceType, surfaceTypeProp, Styles.surfaceTypeNames);
            // Configure blending mode if the surface type is transparent
        ...
        /// <summary>
        /// Draw advanced options: Queue Offset and Material Instancing
        /// </summary>
        /// <param name="material"></param>
        ...
        /// <summary>
        /// Draw Queue Offset as an int slider
        /// </summary>
        ...
        /// <summary>
        /// Draw Emission Texture and HDR Emission Color
        /// </summary>
        ...
        /// <summary>
        /// Use a toggle to control whether to draw the emission properties.
        /// Also deals with the GI emission property.
        /// </summary>
        /// <param name="material"></param>
        /// <param name="keyword">If the material has emission related Keyword</param>
        ...
        /// <summary>
        /// Draw normal map and bump scale property.
        /// If the bump scale is provided, relevant property will be drawn.
        /// </summary>
        /// <param name="materialEditor"></param>
        ...
        /// <summary>
        /// Draw the scale offset of a texture property.
        /// </summary>
        /// <param name="materialEditor"></param>
        /// <param name="textureProp"></param>
        ...
        #region Material Data Functions
        ...
        /// <summary>
        /// Setup the material's render queue, Cast and Receive shadows.
        /// this function is shared with ShaderGraph Lit/Unlit GUIs and also the hand-written GUIs
        /// </summary>
        /// <param name="material"></param>
        /// <param name="automaticRenderQueue"></param>
        ...
        /// <summary>
        /// Setup the Render Queue Control of the Material
