...
{
    /// <summary>
    /// This class is the copied class of LitShader.cs
    /// Only for learning purpose, note the implementation of:
    /// - How the properties struct are declared and initialized.
    /// - How the SurfaceOptions/SurfaceInputs/AdvancedOptions are overriden.
    /// </summary>
