 ...
 * Paper: https://www.jcgt.org/published/0009/03/02/
 *
 * The code is modified by Zoroiscrying to fit the HLSL syntax of Unity URP
 * 
 */
...
// Replace Shadertoy types with Unity URP types
#define uvec2 uint2
#define uvec3 uint3
#define uvec4 uint4
#define vec2 float2
...
float fast(vec2 v)
{
    ...
    float state = fract( dot( v * v, vec2(3571, 3571)));
