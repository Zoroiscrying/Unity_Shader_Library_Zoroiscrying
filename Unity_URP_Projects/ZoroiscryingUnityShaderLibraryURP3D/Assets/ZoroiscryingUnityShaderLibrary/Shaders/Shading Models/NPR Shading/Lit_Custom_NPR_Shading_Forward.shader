Shader "Custom/Shading Model/Lit_Base_NPR_Shading_Forward"
{
    Properties
    {
        ...
        // NPR Shading Lit Properties
        [KeywordEnum(Sharp, Soft, Banded, Halftone)]_DiffuseShadeMode("Diffuse Shade Mode", Float) = 0
        [KeywordEnum(Sharp, Soft, Banded, Halftone)]_SpecularShadeMode("Specualr Shade Mode", Float) = 0
        [Toggle(_SCREEN_SPACE_HALFTONE)] _SCREEN_SPACE_HALFTONE ("Screen space half tone", Float) = 0.0
        ...
        // - Half tone shading - Screen space & Texture space
        _HalfToneTexture("Half Tone Texture", 2D) = "Gery"{}
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            //---------------------------------------
            // Lit NPR Shading Keywords
            #pragma shader_feature _DIFFUSESHADEMODE_SHARP _DIFFUSESHADEMODE_SOFT _DIFFUSESHADEMODE_BANDED _DIFFUSESHADEMODE_HALFTONE
            #pragma shader_feature _SPECULARSHADEMODE_SHARP _SPECULARSHADEMODE_SOFT _SPECULARSHADEMODE_BANDED _SPECULARSHADEMODE_HALFTONE
            #pragma shader_feature _SCREEN_SPACE_HALFTONE
            
            #include "NprShadingLitInput.hlsl"
            #include "BaseNprShadingForwardPass.hlsl"
            ENDHLSL
        }
