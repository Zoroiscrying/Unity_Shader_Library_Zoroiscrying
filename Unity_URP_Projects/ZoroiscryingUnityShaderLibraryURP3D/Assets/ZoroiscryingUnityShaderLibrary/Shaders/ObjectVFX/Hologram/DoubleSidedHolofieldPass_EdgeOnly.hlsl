#ifndef DOUBLE_SIDED_HOLOFIELD_EDGEONLY_PASS
#define DOUBLE_SIDED_HOLOFIELD_EDGEONLY_PASS
...
// -- Edge Emission Control
    ...
    float uvNoise = (value_noise12(uv * half2(16, 8) + _Time.x * _DepthParameter.x) - 0.5) * 2;
