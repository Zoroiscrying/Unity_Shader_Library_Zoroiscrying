Shader "Custom/Object/Crystal"
{
    Properties
    {
        ...
        // Emission ramp bottom to top object space
        [HDR]_TopEmissionColor("Top Emission Color", Color) = (1,1,1,1)
        _TopEmissionRampRange("Top Emission Ramp Range", Float) = 2
        _TopDirection("Top Direction", Vector) = (1,0,0,0)
        // Screen space parallax refraction based on normal & view dir
        _RefractionOffsetStrength("Refraction Offset Strength", Vector) = (1,1,1,1)
        // Inside Sparkles
        _CrystalSparkleTexture("Crystal Sparkle Texture", 2D) = "Grey"{}
        _CrystalSparkleThreshold("Crystal Sparkle Threshold", Range(0.1, 0.99)) = 0.9
        _CrystalSparkleStrength("Crystal Sparkle Strength", Float) = 1.0
        // Light dispersion refraction
        _LightDispersionStrength("Light Dispersion Strength", Vector) = (1,1,1,1)
        // Other effects
        _CrystalInsideMatCapTexture("Inside Mat Cap Texture", 2D) = "Black"{}
    }
