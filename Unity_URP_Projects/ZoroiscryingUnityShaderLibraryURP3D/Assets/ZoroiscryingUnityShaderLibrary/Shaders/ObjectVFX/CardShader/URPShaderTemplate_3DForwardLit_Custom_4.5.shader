Shader "Custom/Object/Base_Card_Shader_Lit"
{
    Properties
    {
        ...
        // Card shader properties
        // View direction based foil ramp
        
        // Parallax mapping based card image
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "../../../ShaderLibrary/Template/CustomLitForwardPass.hlsl"
            ENDHLSL
        }
