Shader "Custom/Template/URPShaderTemplate_Standard"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        // G Buffer pass for deferred rendering, output variable - 4 half4 GBufferN: SV_TargetN & Optional Slots
        // Four standard slots variables:
        // - diffuse           diffuse         diffuse         materialFlags   (sRGB rendertarget)
        // - metallic/specular specular        specular        occlusion
    ...
    // Subshader with shader model 2.0
    SubShader
    {
        // Universal Pipeline tag is required. If Universal render pipeline is not set in the graphics settings
        // this Subshader will fail. One can add a subshader below or fallback to Standard built-in to make this
